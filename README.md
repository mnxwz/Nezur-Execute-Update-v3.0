...
[![Stars](https://img.shields.io/github/stars/Nezur-Execute-Update-v3.0?style=flat-square)](https://github.com)
...
git clone https://github.com/Nezur-Execute-Update-v3.0.git
cd Nezur-Execute-Update-v3.0
